...
public class GameController {
    ...
    public void startNewGame(GameBoard.gameMode mode, int boardSize, boolean enableRecording) {
        ...
        if (enableRecording) {
            currentGame.setRecorder(new GameRecorder());
        }
    }

    public GameRecorder getRecorder() {
        return currentGame.getRecorder();
    }
